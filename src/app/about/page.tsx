        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          <div className="px-6 py-8 sm:px-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">我的故事</h2>
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">我的技术诗篇</h2>
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">与诗人对话</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-6">
