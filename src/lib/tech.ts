...
export function getTechCategoryById(id: string): TechCategory | undefined {
  return techCategories.find(category => category.id === id);
}

export function getTechCategoryByName(name: string): TechCategory | undefined {
  return techCategories.find(category => category.name === name);
}